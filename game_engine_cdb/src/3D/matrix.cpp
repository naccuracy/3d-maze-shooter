...
int LoadRotateMatrix44(float m44[4][4], float angle, float x, float y, float z)
{
 ...
 s=sin(a);
 LoadIdentityMatrix44(m44);
 m44[0][0]=c+(1-c)*x*x;		m44[0][1]=(1-c)*y*x-s*z;	m44[0][2]=(1-c)*z*x+s*y;
 m44[1][0]=(1-c)*x*y+s*z;	m44[1][1]=c+(1-c)*y*y;		m44[1][2]=(1-c)*z*y-s*x;
 m44[2][0]=(1-c)*x*z-s*y;	m44[2][1]=(1-c)*y*z+s*x;	m44[2][2]=c+(1-c)*z*z;
 return 0;
}
