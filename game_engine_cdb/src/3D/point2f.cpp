...
{
 return (sqrt((p.data[0]-data[0])*(p.data[0]-data[0])+(p.data[1]-data[1])*(p.data[1]-data[1])) < N_ACCURACY_1e3);
}
//----------------------------operator>----------------------------------
bool Point2f::operator>(const Point2f& p)
{
 return ((data[0] > p.data[0]) || (fabs(data[0] - p.data[0])<N_ACCURACY_1e3 && (data[1] > p.data[1])));
}
//----------------------------operator<----------------------------------
bool Point2f::operator<(const Point2f& p)
{
