...
bool Point3f::operator>(const Point3f& p)
{
 return ((data[0]>p.data[0])||
         ...
         (data[2]>p.data[2] && fabs(data[0]-p.data[0])<N_ACCURACY_1e3 && fabs(data[1]-p.data[1])<N_ACCURACY_1e3));
}
//----------------------------------------------------------------------------
bool Point3f::operator<(const Point3f& p)
{
...
{
 return Point3f((data[1]*p.data[2] - data[2]*p.data[1]),(data[2]*p.data[0] - data[0]*p.data[2]),(data[0]*p.data[1] - data[1]*p.data[0]));
}
