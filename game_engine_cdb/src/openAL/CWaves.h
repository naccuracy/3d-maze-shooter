...
enum SPEAKERS
{
    ...
    SPEAKER_FRONT_LEFT   = 2,
    SPEAKER_FRONT_RIGHT  = 4,
    SPEAKER_BACK_LEFT    = 8,
    SPEAKER_BACK_RIGHT   = 16,
    SPEAKER_LOW_FREQUENCY = 32,
    SPEAKER_BACK_CENTER = 64,
    SPEAKER_SIDE_LEFT = 128,
    SPEAKER_SIDE_RIGHT = 256
};
enum WAVEFILETYPE
{
	WF_EX  = 1,
